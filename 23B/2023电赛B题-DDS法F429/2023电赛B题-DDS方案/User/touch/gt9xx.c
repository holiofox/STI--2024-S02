 ...
 int32_t GTP_Init_Panel(void)
{
    ...
    GTP_Read_Version(); 
    printf("\r\n提示：\r\n"
           "如果是4.3寸RGB屏幕，使用的触摸芯片可能是GT1151QM。\r\n"
           "如果触摸芯片运行异常，请确认使用的屏幕触摸芯片型号，"
           "在“bsp_i2c_touch.h”文件修改宏定义 LCD_4_3_TOUCH_GT1151QM。\r\n\r\n");
...
//    config[GTP_ADDR_LENGTH+6] |= (X2Y_LOC);
    ...
    else if(touchIC == GT911 || touchIC == GT9157)
    {
